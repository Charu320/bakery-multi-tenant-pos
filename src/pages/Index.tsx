  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <img
                src={logo}
                alt="Royal Live Bakery"
                className="w-12 h-12 object-contain"
              />
              <div>
                <h1 className="text-gold font-display text-xl font-semibold">
                  Royal Live Bakery
                </h1>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <Tabs
          defaultValue={isKitchen ? "kitchen" : "new-order"}
          className="space-y-6"
        >
          <TabsList className="bg-secondary border border-border">
            {isManager && (
         ...
         {isManager && (
          <TabsContent value="new-order" className="animate-fade-in">
            ...
            <div className="mb-6">
              <h2 className="text-gold font-display text-3xl font-semibold">
                Create New Order
              </h2>
              <p className="text-muted-foreground mt-1">
                Fill in the details to book a new cake order
              </p>
            </div>
         ...
         {isManager && (
          <TabsContent value="history" className="animate-fade-in">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground mt-1">
                View and manage all cake orders
              </p>
            </div>
         ...
         {(isManager || isKitchen) && (
          <TabsContent value="kitchen" className="animate-fade-in">
            <div className="mb-6">
              <h2 className="text-gold font-display text-3xl font-semibold">
                Kitchen Order Tickets (KOT)
              </h2>
              <p className="text-muted-foreground mt-1">
                View and update cake preparation status
              </p>
            </div>
